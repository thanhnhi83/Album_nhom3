...
<!--danh mục Lightstick-->
	<div class="row">
		<div class="col-lg-12 col-12">
			<p></p>
			<?php include($_SERVER['DOCUMENT_ROOT']."/views/searchprice_view.php"); ?>
		</div>

	<!--Tên danh mục-->
		<div class="namedm col-lg-2 col-12">
			<p><h3>Lightstick</h3></p>
			<hr style="width:100%; margin-top: 0; margin-bottom: 0">
		</div>
	<!--Danh sách sản phẩm -->
		<div class="infordm col-lg-10 col-12">
			<br>			
			<div class="row mx-1 row-cols-2 row-cols-sm-2 row-cols-md-2 row-cols-lg-4">
			<?php
				if (!isset( $_GET['page'])){
					$page = 1;
				}else{
				...
				$ctg = "Lightstick";//thay tên category
				if (isset($_GET['keyword_sotientu'])and isset($_GET['keyword_sotienden'])){
					$sotientua = $_GET[ 'keyword_sotientu' ];
    				$sotiendenb = $_GET[ 'keyword_sotienden' ];
					require_once($_SERVER['DOCUMENT_ROOT']."/controllers/category_controller.php");
					$controller = new categorycontroller();
					$controller->getpagespr($page, $ctg, $sotientua, $sotiendenb);
				}
				else{
				require_once($_SERVER['DOCUMENT_ROOT']."/controllers/category_controller.php");
				$controller = new categorycontroller();
				$controller->getpagepr($page, $ctg);
				}
			...
			<nav aria-label="Page navigation example" class="col-12">
				...
				<?php
					if (isset($_GET['keyword_sotientu'])and isset($_GET['keyword_sotienden'])){
						...
						require_once($_SERVER['DOCUMENT_ROOT']."/controllers/category_controller.php");
						$controller = new categorycontroller();
						$controller->getpagesp($ctg, $sotientua, $sotiendenb);
					}else{
						require_once($_SERVER['DOCUMENT_ROOT']."/controllers/category_controller.php");
						$controllers = new categorycontroller();
						$controllers->getpage($ctg);
					}					
				?>
				</ul>
			</nav>
...
<div class="footer col-lg-12">
  <div class="row">
    ...
    <div class="lienhe col-lg-3">
      ...
      <ul>
        <li style="list-style-type: none"><img src="https://cdn-icons-png.flaticon.com/512/732/732200.png" alt="mail" width="25" style="margin-right: 15px"><a style="font-size: 12px" href="tuvanalbumgr@gmail.com">tuvanalbumgr@gmail.com</a></li>
    ...
    <div class="col-lg-4">
      ...
      <ul>
        ...
        <p></p>
        <b>
        <li style="list-style-type: none; font-size: 15px">Social Media</li>
        </b><br>
        <li style="list-style-type: none"><a href="#"><img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="fb" width="25" height="25" style="margin-right: 10px"></a><a href="#"><img src="https://cdn-icons-png.flaticon.com/512/3046/3046121.png" alt="tiktok" width="25" height="25" style="margin-right: 10px"></a><a href="#"><img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" alt="insta" width="30" height="30"></a></li>
      </ul>
    </div>
  </div>
</div>
